  ...
  //var offset = canvas.offset();
    ...
    function updateGraph(courseCode, courseNumber) {
		...
		function drawKnowledgePoint(knowledgepoint){
			...
			var color = 'rgba(250, 253, 94, 1)';
			if (knowledgepoint.priority.name === "High"){
				color = 'rgba(255, 77, 77, 1)';
			}else if (knowledgepoint.priority.name === "Medium"){
				color = 'rgba(255, 210, 77, 1)';
			} else if (knowledgepoint.priority.name === "Low"){
